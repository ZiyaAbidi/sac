    ...
    <main className="main">
      <div className="main-wapr">
        ...
        <div className="rightSection">
          <Banner title="Clients" desc="We need some basic information about your company, the product or services that it provides, and where it operates." class="" />
